...
values
(-1,12,0,1,now(),date_add(now(),interval 12 month),1,1,-1,2,'Professional Plan',
...
values
(-1,6,1,1,now(),date_add(now(),interval 12 month),1,1,-1,2,'Growth Plan',
...
insert into pricing_data(price,duration,slot,toshow,start_date,end_date,active,customers_required,upfront_cost,office_type_id,description,plan_summary)
values
(-1,3,2,1,now(),date_add(now(),interval 12 month),1,1,-1,2,'Starter Plan',
