...
export const RECEIVED_SUBS_DATA_SUCCESS = 'RECEIVED_SUBS_DATA_SUCCESS';
export const RECEIVING_SUBS_DATA = 'RECEIVING_SUBS_DATA';

export function receiveDataSuccess(payload) {
    return {
        type: RECEIVED_SUBS_DATA_SUCCESS,
        payload
    }
}

export function subscribe(params,callback,args) { 
