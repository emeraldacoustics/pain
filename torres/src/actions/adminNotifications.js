...
export const RECEIVED_ADNOT_DATA_SUCCESS = 'RECEIVED_ADNOT_DATA_SUCCESS';
export const RECEIVING_ADNOT_DATA = 'RECEIVING_ADNOT_DATA';

export function receiveDataSuccess(payload) {
    return {
        type: RECEIVED_ADNOT_DATA_SUCCESS,
        payload
    }
}

export function getNotifications(params,callback,args) { 
...
export function receivingData(params,callback,args) {
  return async (dispatch) => {
    ...
    const response = await axios.create({ //eslint-disable-line no-unused-vars
        ...
        }).post('/admin/notifications/list',params)
      .then((e) => { 
          var g = e.data.data;
          dispatch({
                type: RECEIVED_ADNOT_DATA_SUCCESS,
