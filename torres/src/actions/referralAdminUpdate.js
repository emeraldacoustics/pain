...
export const RECEIVED_REFUP_DATA_SUCCESS = 'RECEIVED_REFUP_DATA_SUCCESS';
export const RECEIVING_REFUP_DATA = 'RECEIVING_REFUP_DATA';
...
export function receiveDataSuccess(payload) {
    return {
        type: RECEIVED_REFUP_DATA_SUCCESS,
        payload
    }
}

export function referralAdminUpdate(params,callback,args) { 
...
export function receivingData(params,callback,args) {
  return async (dispatch) => {
    ...
    const response = await axios.create({ //eslint-disable-line no-unused-vars
        ...
        }).post('/admin/referral/update',params)
      .then((e) => { 
          dispatch({
                type: RECEIVED_REFUP_DATA_SUCCESS,
                payload: e.data.data
