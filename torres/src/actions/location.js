...
export const RECEIVED_LOCS_DATA_SUCCESS = 'RECEIVED_LOCS_DATA_SUCCESS';
export const RECEIVING_LOCS_DATA = 'RECEIVING_LOCS_DATA';

export function receiveDataSuccess(payload) {
    return {
        type: RECEIVED_LOCS_DATA_SUCCESS,
        payload
    }
}

export function locationUpdate(params,callback,args) { 
