...
export const RECEIVED_CALBACKB_DATA_SUCCESS = 'RECEIVED_CALBACKB_DATA_SUCCESS';
export const RECEIVING_CALBACKB_DATA = 'RECEIVING_CALBACKB_DATA';

export function receiveDataSuccess(payload) {
    return {
        type: RECEIVED_CALBACKB_DATA_SUCCESS,
        payload
    }
}

export function calendarBackendBooking(params,callback,args) { 
