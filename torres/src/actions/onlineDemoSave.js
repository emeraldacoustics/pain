...
export const RECEIVED_ONDES_DATA_SUCCESS = 'RECEIVED_ONDES_DATA_SUCCESS';
export const RECEIVING_ONDES_DATA = 'RECEIVING_ONDES_DATA';

export function receiveDataSuccess(payload) {
    return {
        type: RECEIVED_ONDES_DATA_SUCCESS,
        payload
    }
}

export function onlineDemoSave(params,callback,args) { 
