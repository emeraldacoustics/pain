...
export const RECEIVED_DSQU_DATA_SUCCESS = 'RECEIVED_DSQU_DATA_SUCCESS';
export const RECEIVING_DSQU_DATA = 'RECEIVING_DSQU_DATA';
...
export function receiveDataSuccess(payload) {
    return {
        type: RECEIVED_DSQU_DATA_SUCCESS,
        payload
    }
}

export function datascienceQueriesUpdate(params,callback,args) { 
...
export function receivingData(params,callback,args) {
  return async (dispatch) => {
    ...
    const response = await axios.create({ //eslint-disable-line no-unused-vars
        ...
        }).post('/storage/query/update',params)
      .then((e) => { 
          dispatch({
                type: RECEIVED_DSQU_DATA_SUCCESS,
                payload: e.data.data
