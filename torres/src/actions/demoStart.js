...
export const RECEIVED_ODSTA_DATA_SUCCESS = 'RECEIVED_ODSTA_DATA_SUCCESS';
export const RECEIVING_ODSTA_DATA = 'RECEIVING_ODSTA_DATA';

export function receiveDataSuccess(payload) {
    return {
        type: RECEIVED_ODSTA_DATA_SUCCESS,
        payload
    }
}

export function getDemoStart(params,callback,args) { 
