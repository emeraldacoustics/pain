...
export const RECEIVED_DSRL_DATA_SUCCESS = 'RECEIVED_DSRL_DATA_SUCCESS';
export const RECEIVING_DSRL_DATA = 'RECEIVING_DSRL_DATA';
...
export function receiveDataSuccess(payload) {
    return {
        type: RECEIVED_DSRL_DATA_SUCCESS,
        payload
    }
}

export function getDataScienceResults(params,callback,args) { 
...
export function receivingData(params,callback,args) {
  return async (dispatch) => {
    ...
    const response = await axios.create({ //eslint-disable-line no-unused-vars
        ...
        }).post('/storage/results/list',params)
      .then((e) => { 
          dispatch({
                type: RECEIVED_DSRL_DATA_SUCCESS,
                payload: e.data.data
