...
export const RECEIVED_DSL_DATA_SUCCESS = 'RECEIVED_DSL_DATA_SUCCESS';
export const RECEIVING_DSL_DATA = 'RECEIVING_DSL_DATA';
...
export function receiveDataSuccess(payload) {
    return {
        type: RECEIVED_DSL_DATA_SUCCESS,
        payload
    }
}

export function getDataScienceDataset(params,callback,args) { 
...
export function receivingData(params,callback,args) {
  return async (dispatch) => {
    ...
    const response = await axios.create({ //eslint-disable-line no-unused-vars
        ...
        }).post('/storage/dataset/list',params)
      .then((e) => { 
          dispatch({
                type: RECEIVED_DSL_DATA_SUCCESS,
                payload: e.data.data
