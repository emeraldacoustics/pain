...
export const RECEIVED_DSJOB_DATA_SUCCESS = 'RECEIVED_DSJOB_DATA_SUCCESS';
export const RECEIVING_DSJOB_DATA = 'RECEIVING_DSJOB_DATA';
...
export function receiveDataSuccess(payload) {
    return {
        type: RECEIVED_DSJOB_DATA_SUCCESS,
        payload
    }
}

export function getDataScienceJobs(params,callback,args) { 
