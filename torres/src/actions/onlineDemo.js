...
export const RECEIVED_ODEMO_DATA_SUCCESS = 'RECEIVED_ODEMO_DATA_SUCCESS';
export const RECEIVING_ODEMO_DATA = 'RECEIVING_ODEMO_DATA';

export function receiveDataSuccess(payload) {
    return {
        type: RECEIVED_ODEMO_DATA_SUCCESS,
        payload
    }
}

export function getDemoList(params,callback,args) { 
