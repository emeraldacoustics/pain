...
export const RECEIVED_ODTRAF_DATA_SUCCESS = 'RECEIVED_ODTRAF_DATA_SUCCESS';
export const RECEIVING_ODTRAF_DATA = 'RECEIVING_ODTRAF_DATA';

export function receiveDataSuccess(payload) {
    return {
        type: RECEIVED_ODTRAF_DATA_SUCCESS,
        payload
    }
}

export function getTrafficData(params,callback,args) { 
