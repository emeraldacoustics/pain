                                ...
                                <Grid container xs={12}>
                                    <Grid item xs={5.5}>
                                        <Grid container spacing={1}>
                                            <Grid item xs={12}>
                                                <Typography >Name:<br/>{
                                                        this.props.data.contact.last_name.split('').map((e) => { 
                                                            if (e === '*') { 
                                                                return (
                                        ...
                                        <Grid container spacing={1} style={{marginTop:10}}>
                                            <Grid item xs={12}>
                                                <Typography >Phone:<br/> 
                                                    {!this.props.data.contact.phone.includes('*') ? 
                                                        formatPhoneNumber(this.props.data.contact.phone) : 
                                                        this.blurData(this.props.data.contact.phone)}</Typography>
                                            </Grid>
                                        </Grid>
                                        <Grid container spacing={1} style={{marginTop:10}}>
                                            <Grid item xs={12}>
                                                <Typography >Email:<br/>{
                                                    this.props.data.contact.email ?  this.blurData(this.props.data.contact.email) : ""
                                                }</Typography>
                                            </Grid>
                                        </Grid>
                                        <Grid container spacing={2} style={{marginTop:0}}>
                                            <Grid item xs={12}>
                                                <a style={{color:'lightgreen'}} href="#">Facebook:<br/>{
                                                    this.props.data.contact.facebook ? this.blurData(this.props.data.contact.facebook) : ""
                                                    }
                                                </a>
                                            </Grid>
                                        </Grid>
                                        <Grid container spacing={2} style={{marginTop:10}}>
                                            <Grid item xs={12}>
                                                <a style={{color:'lightgreen'}} href="#">Instagram:<br/>{this.props.data.contact.instagram ? this.blurData(this.props.data.contact.instagram) : ''}</a>
                                            </Grid>
                                        </Grid>
                                        <Grid container spacing={2} style={{marginTop:10}}>
                                            <Grid item xs={12}> 
                                                <a style={{color:'lightgreen'}} href="#">Twitter:<br/>{this.props.data.contact.twitter ? this.blurData(this.props.data.contact.twitter) : ''}</a>
                                            </Grid>
                                        </Grid>
                                    </Grid>
